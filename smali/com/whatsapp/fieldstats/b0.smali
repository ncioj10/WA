...
.method updateFields(Landroid/content/Context;)V
    ...
    sget-object v1, Lcom/whatsapp/fieldstats/an;->RESTORE:Lcom/whatsapp/fieldstats/an;
    ...
    iget-object v1, p0, Lcom/whatsapp/fieldstats/b0;->e:Ljava/lang/Double;
    ...
    iget-object v1, p0, Lcom/whatsapp/fieldstats/b0;->i:Ljava/lang/Double;

    invoke-static {p1, v0, v1}, Lcom/whatsapp/fieldstats/r;->a(Landroid/content/Context;Lcom/whatsapp/fieldstats/a2;Ljava/lang/Double;)V

    .line 13
    iget-object v0, p0, Lcom/whatsapp/fieldstats/b0;->f:Ljava/lang/Double;

    if-eqz v0, :cond_0

    sget-object v0, Lcom/whatsapp/fieldstats/o;->BACKUP_RESTORE_CHATDB_SIZE:Lcom/whatsapp/fieldstats/o;

    iget-object v1, p0, Lcom/whatsapp/fieldstats/b0;->f:Ljava/lang/Double;
    ...
    .line 2
    :cond_0
    iget-object v0, p0, Lcom/whatsapp/fieldstats/b0;->j:Ljava/lang/Double;

    if-eqz v0, :cond_1

    sget-object v0, Lcom/whatsapp/fieldstats/o;->BACKUP_RESTORE_MEDIA_FILE_COUNT:Lcom/whatsapp/fieldstats/o;

    iget-object v1, p0, Lcom/whatsapp/fieldstats/b0;->j:Ljava/lang/Double;

    invoke-static {p1, v0, v1}, Lcom/whatsapp/fieldstats/r;->a(Landroid/content/Context;Lcom/whatsapp/fieldstats/o;Ljava/lang/Double;)V

    .line 9
    :cond_1
    iget-object v0, p0, Lcom/whatsapp/fieldstats/b0;->d:Ljava/lang/Double;
    ...
    .line 11
    :cond_2
    iget-object v0, p0, Lcom/whatsapp/fieldstats/b0;->b:Ljava/lang/Double;
    ...
    .line 12
    :cond_3
    iget-object v0, p0, Lcom/whatsapp/fieldstats/b0;->g:Ljava/lang/Double;

    if-eqz v0, :cond_4

    sget-object v0, Lcom/whatsapp/fieldstats/o;->BACKUP_RESTORE_TOTAL_SIZE:Lcom/whatsapp/fieldstats/o;

    iget-object v1, p0, Lcom/whatsapp/fieldstats/b0;->g:Ljava/lang/Double;

    invoke-static {p1, v0, v1}, Lcom/whatsapp/fieldstats/r;->a(Landroid/content/Context;Lcom/whatsapp/fieldstats/o;Ljava/lang/Double;)V

    .line 14
    :cond_4
    iget-object v0, p0, Lcom/whatsapp/fieldstats/b0;->h:Ljava/lang/Double;

    if-eqz v0, :cond_5

    sget-object v0, Lcom/whatsapp/fieldstats/o;->BACKUP_RESTORE_TRANSFER_SIZE:Lcom/whatsapp/fieldstats/o;

    iget-object v1, p0, Lcom/whatsapp/fieldstats/b0;->h:Ljava/lang/Double;
